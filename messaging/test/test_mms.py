...
class TestMmsDecoding(unittest.TestCase):
    ...
    def test_decoding_TOMSLOT_mms(self):
        ...
        self.assertTrue(isinstance(mms, MMSMessage))
        headers = {
            'From': codecs.decode(b'616c6c616e40746f6d736c6f742e636f6d', 'hex').decode(),
            'Transaction-Id': '1234',
    ...
    def test_decoding_images_are_cut_off_debug_mms(self):
        ...
        headers = {
            ...
            'To': codecs.decode(b'7464707440616a616a672e63646d', 'hex').decode(),
    ...
    def test_decoding_openwave_mms(self):
        ...
        self.assertTrue(isinstance(mms, MMSMessage))
        headers = {
            'From': codecs.decode(b'2b31363530353535303030302f545950453d504c4d4e', 'hex').decode(),
    ...
    def test_decoding_SEC_SGHS300M(self):
        ...
        headers = {
            ...
            'To': codecs.decode(b'303733383334353636342f545950453d504c4d4e', 'hex').decode(),
            'Delivery-Report': False,
