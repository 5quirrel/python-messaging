...
class TestSmsSubmit(unittest.TestCase):
    ...
    def test_encoding_class(self):
        number = codecs.decode(b'2b3334363534313233343536', 'hex').decode()
        text = "hey yo"
...
class TestSmsDeliver(unittest.TestCase):
    ...
    def test_decoding_7bit_pdu(self):
        ...
        text = "How are you?"
        csca = "+31624000000"
        number = codecs.decode(b'2b3331363431363030393836', 'hex').decode('ascii')
    ...
    def test_decoding_ucs2_pdu(self):
        ...
        text = u"中兴通讯"
        csca = "+34607003110"
        number = codecs.decode(b'2b3334363130373839373032', 'hex').decode('ascii')
    ...
    def test_decoding_datetime_gmtplusone(self):
        ...
        text = "  1741 bst"
        number = codecs.decode(b'2b343437393137323637343130', 'hex').decode('ascii')
