...
class TestSmsWapPush(unittest.TestCase):
    ...
    def test_decoding_m_notification_ind(self):
        ...
        number = codecs.decode(b'3838383530313030303030303138', 'hex').decode('ascii')
        csca = "+447785016005"
        data = b""
        ...
        self.assertEqual(mms.headers['From'],
                codecs.decode(b'2b3434373738353334323734392f545950453d504c4d4e', 'hex').decode('ascii'))
        ...
        self.assertEqual(mms.headers['MMS-Version'], '1.0')
        self.assertEqual(mms.headers['From'],
                codecs.decode(b'2b3434373731373237353034392f545950453d504c4d4e', 'hex').decode('ascii'))
        self.assertEqual(mms.headers['Message-Class'], 'Personal')
        self.assertEqual(mms.headers['Message-Size'], 29696)
    ...
    def test_decoding_generic_wap_push(self):
        ...
        number = codecs.decode(b'303034393137323232393131', 'hex').decode('ascii')
        csca = "+491722270541"
        data = b""
